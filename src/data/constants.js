...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    resposta:
      "Sim! Fazemos coleta e entrega para clientes Prata, Ouro e Diamante. Para clientes Bronze, a coleta tem um valor adicional.",
  },
  {
    id: "f3",
    pergunta: "Como funciona o programa de pontos?",
    resposta:
      "Você ganha 1 ponto por cada R$ 1 gasto. Os pontos podem ser trocados por serviços grátis, descontos e kits exclusivos.",
  },
  {
    id: "f4",
  ...
  {
    id: "f5",
    pergunta: "Os valores mostrados no app são definitivos?",
    resposta:
      "Os valores são estimativas. O valor final é confirmado após avaliação presencial.",
  },
  {
    id: "f6",
    pergunta: "Posso acompanhar meu serviço em andamento?",
    resposta:
      'Sim! Na aba "Meus Pedidos" você vê em tempo real cada etapa do seu serviço.',
  },
];
...
export const LOCATION = {
  ...
  descricao:
    "Atendemos São Paulo e Regiões. Coleta e entrega disponível para clientes Ouro e Diamante.",
