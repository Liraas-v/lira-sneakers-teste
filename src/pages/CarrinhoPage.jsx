 ...
 *
 * MUDANÇAS vs. app:
 * - Layout 2 colunas em desktop: lista de itens (esq) | resumo sticky (dir)
 * - Resumo fixo na coluna direita (position: sticky)
 * - window.open com _blank para não redirecionar a página
 * - Botão de quantidade com -/+ em vez de só remover
 */
    ...
    <div style={{ paddingBottom: 80 }}>
      ...
      {cart.length === 0 ? (
        ...
        <div style={{
          ...
          <p style={{ fontWeight: 900, fontSize: 14, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
            Orçamento vazio
          </p>
          <p style={{ fontSize: 13, color: 'var(--text-dim)', maxWidth: 280 }}>
            Adicione serviços para montar seu orçamento e enviá-lo via WhatsApp.
          </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: 24, alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
              ...
              <button onClick={clearCart}
                style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-dim)', fontSize: 12, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                Limpar tudo
              </button>
            </div>
            ...
            {cart.map(item => (
              ...
              >
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{ fontWeight: 700, fontSize: 13, color: 'var(--text)', textTransform: 'uppercase' }}>
                    {item.titulo}
                  </p>
          ...
          <div style={{ position: 'sticky', top: 24 }}>
            <div className="card">
              <p style={{ fontWeight: 900, fontSize: 13, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 18 }}>
                Resumo
              </p>
              ...
              <button
                ...
                style={{ width: '100%', fontSize: 14, padding: '14px 24px' }}
              >
              ...
              <p style={{ fontSize: 10, color: 'var(--text-dim)', textAlign: 'center', marginTop: 10, lineHeight: 1.4 }}>
                O valor final é confirmado após avaliação. Nossa equipe responde em até 1h.
              </p>
            </div>
          </div>
        </div>
