  ...
  return (
    <div style={{ paddingBottom: 80 }}>
      <PageHeader
        title="Meu Orçamento"
        back="servicos"
        subtitle="Valores a partir de — confirmação via WhatsApp"
      />
      {cart.length === 0 ? (
        <div
          style={{
        ...
        >
          ...
          <div style={{ position: "sticky", top: 24 }}>
            <div className="card">
                ...
                {nextTier && (
                  <>
                    ...
                    <p style={{ fontSize: 11, color: "var(--text-dim)" }}>
                      {Math.max(
                        0,
                        nextTier.min - (user?.pontos ?? 0) - cartTotal,
                      ) > 0
              ...
              >
                O valor final é confirmado após avaliação. Nossa equipe responde
                em até 1h.
              </p>
            </div>
          </div>
