  ...
  return (
    <div style={{ marginTop: 16 }}>
      {etapas.map((etapa, i) => {
        ...
        const isCurrent =
          etapa.concluida && (isLast || !etapas[i + 1]?.concluida);
        return (
              ...
              {!isLast && (
                <div
                  style={{
                    ...
                    margin: "3px 0",
                    background:
                      etapa.concluida && etapas[i + 1]?.concluida
                        ? "var(--green)"
                        : "var(--border)",
      ...
      <div className="page-wrap">
        {pedidos.length === 0 ? (
          ...
          >
            ...
            >
              <Icon name="list" size={14} /> Ver serviços
            </button>
          </div>
        ) : (
          <>
