...
export default function SuportePage() {
  ...
  const MENSAGENS_RAPIDAS = [
    ...
    [
      "Status do pedido",
      `Olá! Sou o(a) ${user?.nome ?? "cliente"} e gostaria de saber o status do meu pedido.`,
    ],
              ...
              {CANAIS.map((canal, i) => (
                ...
                >
                  <Icon
                    name={canal.icon}
                    size={22}
                    style={{ color: canal.cor, flexShrink: 0 }}
                  />
                  <div style={{ flex: 1 }}>
                    <p
                      style={{
